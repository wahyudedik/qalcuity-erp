...
use App\Events\Modul\Umum\MessageSent;
use App\Models\Modul\Umum\Message;
use App\Events\Modul\Umum\UserStatusChanged;
use App\Models\Modul\Umum\Participant;
use App\Models\Modul\Umum\Conversation;
use App\Http\Requests\Modul\Umum\ChatRequest;
use App\Models\Modul\Umum\MessageRead;
...
class ChatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('modul.umum.chat.chat', compact('conversations', 'currentConversation'));
    }
     ...
     */
    public function createGroupConversation(ChatRequest $request)
    {
        try {
            // Validasi data group
     ...
     * Send a message.
     */
    public function sendMessage(ChatRequest $request, Conversation $conversation)
    {
        // Check if user is part of this conversation
        $isParticipant = $conversation->participants()->where('user_id', Auth::id())->exists();
    ...
    {
        $onlineUsers = UserOnlineStatus::where('is_online', true)
