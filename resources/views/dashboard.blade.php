...
@section('breadcrumb-items')
    <li class="inline-flex items-center">
        ...
        <span class="ml-1 text-xs font-medium text-gray-500 md:ml-2 dark:text-gray-400">Dashboard</span>
    </li>
@endsection
...
@section('content')
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-blue-100 dark:bg-blue-900 mr-4">
                    <svg class="w-6 h-6 text-blue-600 dark:text-blue-300" aria-hidden="true"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
                    <svg class="w-6 h-6 text-green-600 dark:text-green-300" aria-hidden="true"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-purple-100 dark:bg-purple-900 mr-4">
                    <svg class="w-6 h-6 text-purple-600 dark:text-purple-300" aria-hidden="true"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-center">
                <div class="p-3 rounded-full bg-orange-100 dark:bg-orange-900 mr-4">
                    <svg class="w-6 h-6 text-orange-600 dark:text-orange-300" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 lg:col-span-2">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center space-x-2">
                    <button id="dropdownDefaultButton" data-dropdown-toggle="chartTimeDropdown"
                        class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-3 py-1.5 text-center inline-flex items-center dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-800 border border-gray-200 dark:border-gray-600"
                        type="button">
                        Tahun 2023
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Lihat
                    Semua</a>
            </div>
            <div class="flow-root">
                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    <li class="py-3 sm:py-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="inline-flex items-center text-xs font-medium">
                                <span
                                    class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Hari
                                    Ini</span>
                            </div>
                        </div>
                    </li>
                    <li class="py-3 sm:py-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="inline-flex items-center text-xs font-medium">
                                <span
                                    class="bg-purple-100 text-purple-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">Besok</span>
                            </div>
                        </div>
                    </li>
                    <li class="py-3 sm:py-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="inline-flex items-center text-xs font-medium">
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">18
                                    Okt</span>
                            </div>
                        </div>
                    </li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Kelola
                    Stok</a>
            </div>
            <div class="space-y-3">
                <!-- Semen -->
                ...
                <div>
                    <div class="flex justify-between mb-1">
                        ...
                        <span class="text-sm font-medium text-yellow-500 dark:text-yellow-400">45%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                ...
                <div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                        <div class="bg-orange-500 h-2 rounded-full" style="width: 22%"></div>
                    </div>
                    <div class="flex justify-between mt-1">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="bg-green-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="flex justify-center mb-2">
                        <div
                            class="inline-flex items-center justify-center w-10 h-10 text-green-500 bg-green-100 rounded-lg dark:bg-green-900 dark:text-green-300">
                    ...
                    <div class="text-center">
                        <h5 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">8</h5>
                        <p class="text-xs font-normal text-gray-700 dark:text-gray-400">Supir Tersedia</p>
                    </div>
                </div>
                <div class="bg-blue-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="flex justify-center mb-2">
                        <div
                            class="inline-flex items-center justify-center w-10 h-10 text-blue-500 bg-blue-100 rounded-lg dark:bg-blue-900 dark:text-blue-300">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="text-center">
                        <h5 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">12</h5>
                        <p class="text-xs font-normal text-gray-700 dark:text-gray-400">Mixer Tersedia</p>
                    </div>
                </div>
                <div class="bg-purple-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="flex justify-center mb-2">
                        <div
                            class="inline-flex items-center justify-center w-10 h-10 text-purple-500 bg-purple-100 rounded-lg dark:bg-purple-900 dark:text-purple-300">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path
                    ...
                    <div class="text-center">
                        <h5 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">4</h5>
                        <p class="text-xs font-normal text-gray-700 dark:text-gray-400">Pompa Tersedia</p>
                    </div>
                </div>
                <div class="bg-red-50 dark:bg-gray-700 p-3 rounded-lg">
                    <div class="flex justify-center mb-2">
                        <div
                            class="inline-flex items-center justify-center w-10 h-10 text-red-500 bg-red-100 rounded-lg dark:bg-red-900 dark:text-red-300">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 20 20">
                                <path
                    ...
                    <div class="text-center">
                        <h5 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">3</h5>
                        <p class="text-xs font-normal text-gray-700 dark:text-gray-400">Dalam Perbaikan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-3 py-2">ID Pesanan</th>
                            <th scope="col" class="px-3 py-2">Pelanggan</th>
                    ...
                    <tbody>
                        <tr
                            ...
                            <td class="px-3 py-2">PT Bangun Perkasa</td>
                            <td class="px-3 py-2">17 Okt 2023</td>
                            <td class="px-3 py-2">Beton K-350</td>
                            <td class="px-3 py-2">Rp 35,000,000</td>
                            <td class="px-3 py-2">
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Lunas</span>
                            </td>
                        </tr>
                        <tr
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-3 py-2">PT Maju Bersama</td>
                            <td class="px-3 py-2">16 Okt 2023</td>
                            <td class="px-3 py-2">Beton K-250</td>
                            <td class="px-3 py-2">Rp 42,500,000</td>
                            <td class="px-3 py-2">
                                <span
                                    class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Menunggu
                                    Pembayaran</span>
                            </td>
                        </tr>
                        <tr
                            ...
                            <td class="px-3 py-2">PT Konstruksi Utama</td>
                            <td class="px-3 py-2">15 Okt 2023</td>
                            <td class="px-3 py-2">Beton K-300</td>
                            <td class="px-3 py-2">Rp 68,250,000</td>
                            <td class="px-3 py-2">
                                <span
                                    class="bg-purple-100 text-purple-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">Dalam
                                    Proses</span>
                            </td>
                        </tr>
                        <tr
                            ...
                            <td class="px-3 py-2">PT Gedung Tinggi</td>
                            <td class="px-3 py-2">14 Okt 2023</td>
                            <td class="px-3 py-2">Beton K-400</td>
                            <td class="px-3 py-2">Rp 92,000,000</td>
                            <td class="px-3 py-2">
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Lunas</span>
                            </td>
                        ...
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-3 py-2">PT Sejahtera Abadi</td>
                            <td class="px-3 py-2">13 Okt 2023</td>
                            <td class="px-3 py-2">Beton K-300</td>
                            <td class="px-3 py-2">Rp 38,250,000</td>
                            <td class="px-3 py-2">
                                <span
                                    class="bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Lunas</span>
                            </td>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            ...
            <ol class="relative border-l border-gray-200 dark:border-gray-700 space-y-4 ml-3">
                <li class="ml-5">
                    <div
                    ...
                    <time class="mb-1 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">Baru saja</time>
                    <h3 class="text-xs font-semibold text-gray-900 dark:text-white">Pengiriman #DEL-2023-0458 selesai</h3>
                ...
                <li class="ml-5">
                    ...
                    <time class="mb-1 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">20 menit yang
                        lalu</time>
                    <h3 class="text-xs font-semibold text-gray-900 dark:text-white">Pesanan #ORD-2023-1853 dibuat</h3>
                ...
                <li class="ml-5">
                    ...
                    <time class="mb-1 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">45 menit yang
                        lalu</time>
                    <h3 class="text-xs font-semibold text-gray-900 dark:text-white">Pembayaran #INV-2023-0987 diterima</h3>
                ...
                <li class="ml-5">
                    ...
                    <time class="mb-1 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">2 jam yang
                        lalu</time>
                    <h3 class="text-xs font-semibold text-gray-900 dark:text-white">Maintenance pompa #P003 selesai</h3>
                ...
                <li class="ml-5">
                    ...
                    <time class="mb-1 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">4 jam yang
                        lalu</time>
                    <h3 class="text-xs font-semibold text-gray-900 dark:text-white">Stok semen mendekati batas minimum</h3>
    ...
    <script>
        ...
        document.addEventListener('dark-mode', function(e) {
            ...
            productDistributionChart.options.plugins.legend.labels.color = isDark ? 'rgba(255, 255, 255, 0.7)' :
                'rgba(55, 65, 81, 0.7)';
            productDistributionChart.data.datasets[0].borderColor = isDark ?
                'rgba(31, 41, 55, 1)' : 'rgba(255, 255, 255, 1)';
