        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="ml-4 md:ml-6">
                    <button id="branch-dropdown-button" data-dropdown-toggle="branch-dropdown"
                        class="text-gray-700 bg-white hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-blue-800 dark:text-white border border-gray-200 dark:border-gray-600"
                        type="button">
                        <span class="mr-2">Cabang Pusat</span>
                    ...
                    <div id="branch-dropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                            aria-labelledby="branch-dropdown-button">
                            <li>
                                <a href="#"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cabang
                                    Pusat</a>
                            </li>
                            <li>
                                <a href="#"
            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center mr-4">
                    <button id="quick-actions-button" data-dropdown-toggle="quick-actions-dropdown"
                        class="hidden sm:inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400"
                        type="button">
                    ...
                    <div id="quick-actions-dropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                            ...
                            <li>
                                <a href=""
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Absen</a>
                            </li>
                            <li>
                                <a href=""
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Ajukan
                                    Cuti</a>
                            </li>
                            <li>
                                <a href=""
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Buat
                                    Rencana Produksi</a>
                            </li>
                        </ul>
                    </div>
                ...
                <a href="{{ route('cameras.index') }}"
                    class="relative p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                    <span class="sr-only">CCTV</span>
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 14">
                        <path
                            d="M11 0H2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm8.585 1.189a.994.994 0 0 0-.9-.138l-2.965.983a1 1 0 0 0-.685.949v8a1 1 0 0 0 .675.946l2.965 1.02a1 1 0 0 0 1.325-.946V2a1 1 0 0 0-.415-.811Z" />
                    </svg>
                </a>
